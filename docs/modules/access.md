...
| A5/R6 | **Multi-salons** (pre-launch, sign-off 2026-07-11): switcher + « Ajouter un salon » + Réseau gating + badge inheritance — **R6a (backend: the `?salonId=` selector via `salonForRequest`, GET/POST /me/salons, KYC badge fan-out, deletion across all owned salons; threat T55) ✅ 2026-07-12** (docs/design/team-access-r6-multi-salons.md); R6b app + R6c web follow | pre-launch |
