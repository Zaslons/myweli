...
9. **Pro V1** — ✅ KYC submission + verification status; ✅ guided onboarding checklist; remaining: manual booking entry, no-show marking, price ranges/duration variants/buffers/commission fields, payouts UI.
...
- ⏳ **Still V1-open:** booking buffers / duration-by-length (#4 partial); profile avatar upload (#8 partial); Pro V1 — manual booking entry, no-show marking, payouts (#9); flag-hide the unrouted V2/V3 feature screens (#10).
