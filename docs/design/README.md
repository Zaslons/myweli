...
| Journal J1 — the web journal grid (+ « Client arrivé ») | [journal-j1-grid.md](journal-j1-grid.md) | **Draft** — flagship day grid w/ drag + quick-create (C2 inside); awaiting sign-off |
