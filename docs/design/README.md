...
| Clients C1 — salon client base (list · card · notes · tags · badge) | [clients-c1.md](clients-c1.md) | **Draft** — first build slice of [modules/clients.md](../modules/clients.md); awaiting sign-off |
