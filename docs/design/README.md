...
| Part | Spec | Status |
|------|------|--------|
| Auth overhaul — Google + Apple + Email OTP (phone → contact) | [auth-social-email.md](auth-social-email.md) | **Approved** — replaces SMS-OTP login (too costly for CI); phone becomes contact (verified later via Termii); build phased |
