...
| Pro salon lifecycle (draft → publish) | [pro-salon-lifecycle.md](pro-salon-lifecycle.md) | **Built (B1 backend)** — registration provisions a linked DRAFT salon (+ /me/provider self-heal for stuck accounts); « Mettre en ligne » gate (profile · ≥3 services · ≥3 photos · hours); drafts invisible publicly (T50/T51) |
