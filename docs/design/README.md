...
| Web team access R5 — /pro/equipe, invitation bridge, offer picker, role-shaped web | [web-team-access-r5.md](web-team-access-r5.md) | **Approved** — R5a (owner surfaces: équipe table, 202 login bridge, offer picker, publish `offer` key, catalogue rename) · R5b (membership context, capability sidebar, own-calendar, slim member profil, revoked sign-out) |
