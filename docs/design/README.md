...
| Team access R6 — multi-salons | [team-access-r6-multi-salons.md](team-access-r6-multi-salons.md) | **Approved** — R6a backend (`?salonId=` selector, GET/POST /me/salons, KYC badge fan-out, deletion-all) · R6b app (switcher + add-salon) · R6c web (sidebar switcher + salon cookie) |
