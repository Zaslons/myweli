...
| Web B8 — the reading-text resize: bodyLarge where you read, 16px where you type, 14 where you scan (design system B8) | [web-b8-reading-text.md](web-b8-reading-text.md) | **In progress** — row 17's three-way correction (308 not 356 · bodyLarge at ZERO not once · mobile itself reads paragraphs at 14): the HYBRID split (reading copy → 16, operator density stays 14 by doctrine) + ALL inputs type at 16 (M3 parity, iOS stops zooming); mobile's own 14px paragraphs become a new SYSTEM §21 row |
