...
| Admin / ops console — UI (Flutter Web) | [admin-console-ui.md](admin-console-ui.md) | UX signed off · UI-2a (system + rework) + UI-2b (moderation) built · provider/user mgmt next |
