...
| Team access R4 — the role-shaped pro app | [team-access-r4-role-shaped-app.md](team-access-r4-role-shaped-app.md) | **Approved** — R4a backend (membership-aware /me/provider, T40 own-scope + off-day contact masking, not_a_member) · R4b app (role-gated dashboard/profil, staff 3-tab « Ma journée » shell, revoked sign-out) |
