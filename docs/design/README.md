...
| Web consumer auth — Google + Apple + Email OTP (P2) | [web-auth-social.md](web-auth-social.md) | **Draft** — BFF routes + LoginOptions + booking-confirm sign-in + contact phone; awaiting sign-off |
