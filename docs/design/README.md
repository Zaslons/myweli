...
| Public web surface — SSR pages, SEO & web booking (FR-WEB-PP/MP) | [public-web.md](public-web.md) | Planned — OQ-8 resolved (dart_frog SSR); 4-PR breakdown, awaiting sign-off |
