...
| Part | Spec | Status |
|------|------|--------|
| Multi-pays — the end version, built (program MP1→MP3) | [multi-pays-end-version.md](multi-pays-end-version.md) | **MP1 backend (#235) + MP2 mobile built — MP3 web in build** — locality tree + /localities, per-salon timezone (package:timezone through all day-math + both app surfaces), per-salon currency stamping + threading, operator catalog end-to-end, nested SEO tree + permanent redirects (MP3); user decision 2026-07-14 |
