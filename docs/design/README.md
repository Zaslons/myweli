...
| Multi-chair capacity + web booking hub | [booking-capacity-web-hub.md](booking-capacity-web-hub.md) | **Signed off** — per-artist slot engine (K1) + the order-free web booking hub porting the app flow (K2) + app artistId fix (K3) |
