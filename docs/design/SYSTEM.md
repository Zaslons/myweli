...
of the day it was taken". Six baselines that could not exist now do:
`pro_dashboard`, `pro_journal`, `pro_journal_day`, `pro_earnings`, plus the two
consumer screens that were stable **by luck** and are now stable by construction.
