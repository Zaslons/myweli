...
`mobile/test/golden/` holds **33** goldens, and they are the **only** thing in the
...
- **A rendering CONDITION** (`*_w360`, `*_w360_x2`) — six baselines: five added
  by A11 C7 and a sixth, `pro_login_w360_x2`, by C8. The first whose reason for
