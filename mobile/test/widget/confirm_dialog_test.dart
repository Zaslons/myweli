...
void main() {
  ...
  testWidgets('the CANCEL path takes focus — the safe default (§15, §13.5)', (
    ...
    expect(
      focusedBox.overlaps(cancelBox),
      isTrue,
      reason:
          'primary focus should sit on « Annuler », not the destructive '
  ...
  testWidgets('§13.1 — it SCROLLS instead of overflowing at 200 % text', (
    ...
    await open(
      ...
      (c) => showConfirmDialog(
        ...
        message:
            'Cette action est irréversible. Votre salon, vos services, '
