...
void main() {
  ...
  test(
    'createArtist POSTs; serializes workingHours; omits server fields',
    () async {
  ...
  test(
    'updateArtist/deleteArtist resolve the salon from the session',
    () async {
      final calls = <String>[];
      ...
      expect(
        (await _linked(
          client(),
        ).updateArtist('artist1', {'name': 'A'})).success,
        isTrue,
      );
