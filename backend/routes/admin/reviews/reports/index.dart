...
/// `GET /admin/reviews/reports` — the moderation queue: reviews with open
/// reports (one row each), paginated. Design: docs/design/admin-console.md.
Future<Response> onRequest(RequestContext context) async {
  ...
  final r = await context.read<ModerationService>().queue(
    page: page,
    pageSize: pageSize,
  );
