...
# rebuild on every status transition that changes the public set - publish,
# republish-on-payment, billing unpublish, erasure, admin suspend/restore.
# (Until 2026-08-25 this header said "created, suspended or restored" - but
# creation makes a draft, which the set excludes, and publish fired nothing.)
#
...
# what makes the failure INVISIBLE - the operator sees a salon published, the
