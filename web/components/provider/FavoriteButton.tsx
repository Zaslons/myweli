...
export function FavoriteButton({
  ...
  return (
    <button
      ...
      disabled={busy}
      aria-pressed={fav}
      className="inline-flex items-center gap-xs rounded-lg border border-border bg-secondary px-m py-s text-sm font-medium text-textPrimary hover:bg-surfaceVariant"
    >
